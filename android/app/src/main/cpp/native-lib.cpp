...
extern "C"
jstring
Java_com_chemenghelper_CPPConnection_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C"
jdouble
Java_com_chemenghelper_CPPConnection_convertToSI(
        JNIEnv* env,
...
extern "C"
jdouble
Java_com_chemenghelper_CPPConnection_ReynoldsNumber(
        JNIEnv* env,
...
extern "C"
jdouble
Java_com_chemenghelper_CPPConnection_FrictionFactor(
        JNIEnv* env,
...
extern "C"
jdouble
Java_com_chemenghelper_CPPConnection_PipePressureDropIncompressible(
        JNIEnv* env,
...
extern "C"
jdouble
Java_com_chemenghelper_CPPConnection_PipePressureDropCompressible(
        JNIEnv* env,
